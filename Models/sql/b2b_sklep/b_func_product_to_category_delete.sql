...
-- Zrzut struktury b_func_product_to_category_delete
DELIMITER //
CREATE  ` FUNCTION `b_func_product_to_category_delete`(`id_category_in` INT, `id_product_in` INT) RETURNS tinytext CHARSET utf8
    READS SQL DATA
BEGIN
