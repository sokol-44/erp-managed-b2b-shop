...
-- Zrzut struktury b_func_order_status_change
DELIMITER //
CREATE  ` FUNCTION `b_func_order_status_change`(`id_order_in` INT, `id_order_status_in` INT, `timestamp_in` TIMESTAMP, `description_in` TEXT) RETURNS tinytext CHARSET utf8
    READS SQL DATA
BEGIN
