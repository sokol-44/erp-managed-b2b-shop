...
-- Zrzut struktury funkcja company_20.b_func_product_delete
DELIMITER //
CREATE DEFINER=`company_20`@`%` FUNCTION `b_func_product_delete`(`id_product_in` INT) RETURNS tinytext CHARSET utf8
    READS SQL DATA
BEGIN
