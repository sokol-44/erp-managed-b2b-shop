...
-- Zrzut struktury procedura company_20.b_proc_client_user_attribute_set
DELIMITER //
CREATE DEFINER=`company_20`@`%` PROCEDURE `b_proc_client_user_attribute_set`(`id_client_in` INT, `id_client_user_in` INT, `type_in` TEXT, `val_in` TEXT)
BEGIN
