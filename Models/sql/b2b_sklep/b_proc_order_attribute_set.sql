...
-- Zrzut struktury procedura company_20.b_proc_order_attribute_set
DELIMITER //
CREATE DEFINER=`company_20`@`%` PROCEDURE `b_proc_order_attribute_set`(`id_order_in` INT, `type_in` TEXT, `val_in` TEXT)
BEGIN
