...
-- Zrzut struktury b_func_product_category_check_exist
DELIMITER //
CREATE  ` FUNCTION `b_func_product_category_check_exist`(`id_category_in` INT, `id_product_in` INT) RETURNS tinytext CHARSET utf8
    READS SQL DATA
BEGIN
