...
# Dumping structure for procedure b2b_sklep.test_trzy
DROP PROCEDURE IF EXISTS `test_trzy`;
DELIMITER //
CREATE DEFINER=`root`@`localhost` PROCEDURE `test_trzy`()
BEGIN
...
DECLARE stream_at_idx TINYBLOB default '';
