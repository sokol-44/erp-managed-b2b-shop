...
-- Zrzut struktury b_func_client_user_delete
DELIMITER //
CREATE  ` FUNCTION `b_func_client_user_delete`(`id_client_user_in` INT, `id_client_in` INT) RETURNS tinytext CHARSET utf8
    READS SQL DATA
BEGIN
