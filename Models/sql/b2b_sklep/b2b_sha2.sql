...
-- Zrzut struktury funkcja b2b_sklep.b2b_sha2
DROP FUNCTION IF EXISTS `b2b_sha2`;
DELIMITER //
CREATE DEFINER=`root`@`localhost` FUNCTION `b2b_sha2`(`message` MEDIUMBLOB, `bits` SMALLINT) RETURNS char(64) CHARSET utf8
    DETERMINISTIC
BEGIN
