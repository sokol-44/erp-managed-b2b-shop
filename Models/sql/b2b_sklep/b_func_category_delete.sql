...
-- Zrzut struktury funkcja company_20.b_func_category_delete
DELIMITER //
CREATE DEFINER=`company_20`@`%` FUNCTION `b_func_category_delete`(`id_category_in` INT) RETURNS tinytext CHARSET utf8
    READS SQL DATA
BEGIN
