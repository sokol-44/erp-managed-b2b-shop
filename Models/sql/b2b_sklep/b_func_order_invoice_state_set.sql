...
-- Zrzut struktury funkcja company_20.b_func_order_invoice_state_set
DELIMITER //
CREATE DEFINER=`company_20`@`%` FUNCTION `b_func_order_invoice_state_set`(`id_invoice_in` INT, `id_order_in` INT, `state_in` VARCHAR(50)) RETURNS tinytext CHARSET latin2
    MODIFIES SQL DATA
BEGIN
