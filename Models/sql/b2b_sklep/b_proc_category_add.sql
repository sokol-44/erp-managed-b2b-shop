...
-- Zrzut struktury procedura company_22.b_proc_category_add
DELIMITER //
CREATE  ` PROCEDURE `b_proc_category_add`(IN `id_category_in` INT, IN `id_category_parent_in` INT, IN `sort_order_in` INT, IN `root_number_in` TINYINT, IN `name_in` TEXT, IN `description_in` TEXT)
BEGIN
