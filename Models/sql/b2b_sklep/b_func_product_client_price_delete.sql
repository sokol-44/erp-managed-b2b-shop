...
-- Zrzut struktury funkcja company_20.b_func_product_client_price_delete
DELIMITER //
CREATE DEFINER=`company_20`@`%` FUNCTION `b_func_product_client_price_delete`(`id_client_in` INT, `id_product_in` INT) RETURNS tinytext CHARSET utf8
    MODIFIES SQL DATA
    DETERMINISTIC
BEGIN
