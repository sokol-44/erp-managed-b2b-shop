...
-- Zrzut struktury b_func_client_user_attribute_set
DELIMITER //
CREATE  ` FUNCTION `b_func_client_user_attribute_set`(`id_client_in` INT, `id_client_user_in` INT, `type_in` TEXT, `val_in` TEXT) RETURNS tinytext CHARSET latin2
    READS SQL DATA
BEGIN
