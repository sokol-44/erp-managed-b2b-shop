...
-- Zrzut struktury b_func_product_to_category_set_product_category
DELIMITER //
CREATE  ` FUNCTION `b_func_product_to_category_set_product_category`(`id_category_in` INT, `id_product_in` INT) RETURNS tinytext CHARSET utf8
    READS SQL DATA
BEGIN
