...
-- Zrzut struktury funkcja company_1.b_func_client_user_set_address
DROP FUNCTION IF EXISTS `b_func_client_user_set_address`;
DELIMITER //
CREATE DEFINER=`company_1`@`%` FUNCTION `b_func_client_user_set_address`(`id_address_in` INT, `id_client_user_in` INT, `id_client_in` INT, `description_in` TEXT, `name_in` TEXT, `street_in` TEXT, `city_in` TEXT, `zip_code_in` TEXT, `country_in` TEXT) RETURNS text CHARSET latin2
    MODIFIES SQL DATA
BEGIN
