...
-- Zrzut struktury b_func_order_attribute_set
DELIMITER //
CREATE  ` FUNCTION `b_func_order_attribute_set`(`id_order_in` INT, `type_in` TEXT, `val_in` TEXT) RETURNS tinytext CHARSET latin2
    READS SQL DATA
BEGIN
