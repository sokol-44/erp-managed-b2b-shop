...
$small_image_html = $F->static_image($small_image_path, Lang::_('add basket'));;
...
$GET_basket = array('mode' => 'add_basked', 'id_product' => $id_product);
$link_basket = $F->make_link(CFG_COM_BASKET, $F->add_local_get($GET_basket, '', $GET_tmp) );
$add_basket_html = $F->draw_link($link_basket, 'onclick="add_basked()" title="' . Lang::_('add_basked') . '"', $F->static_image('icon/buy_16.png', Lang::_('add_basked')));
