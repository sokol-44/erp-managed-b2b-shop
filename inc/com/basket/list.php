...
<table style="border: 0; width: 100%;">
	...
	<tr>
		<td colspan="5">asasa
      <?php
      echo $F->draw_submit(Lang::_('SEND BASKET HIGHER'));
      echo $F->draw_submit(Lang::_('SEND BASKET LOWER'));
       ?>
      </td>
	</tr>
<?php
//FIXME
//order/up/down
$F->draw_submit(Lang::_('PREPARE ORDER_BASKET'));
$F->draw_submit(Lang::_('SEND BASKET HIGHER'));
$F->draw_submit(Lang::_('SEND BASKET LOWER'));
//-> change level (to FREE_"new level")

?>
	<tr>
		<td align="right"><?php echo $F->draw_submit('PREPARE_ORDER_BASKET', false, Lang::_('PREPARE_ORDER_BASKET')); ?></td>
