...
$n=0;
	while( $Shopping_Basket = $Shopping_Basket_Chain->return_basket_next_modify( true ) ) {
	   include DIR_INC_COMPONENTS . DS . 'mod_in' . DS . 'basket_list_row.php';
	   $n++;
	   if( $n>12 ) die();
	}
	...
	$Shopping_Basket_Chain->reset_basket_list();
$n=0;
	while( $Shopping_Basket = $Shopping_Basket_Chain->return_basket_next_view( true ) ) {
	   include DIR_INC_COMPONENTS . DS . 'mod_in' . DS . 'basket_list_row.php';
	   $n++;
	   if( $n>12 ) die();
	}
...
<table class="basket_container basket_tools">
	<tr>
		<td align="right"><?php echo $add_basket ?></td>
	</tr>
</table>
<?php
}
