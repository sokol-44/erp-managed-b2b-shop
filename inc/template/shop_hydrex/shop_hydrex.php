...
<link href="inc/template/shop_hydrex/css/my_layout.css?mt=<?php echo microtime(true)?>" rel="stylesheet" type="text/css" >
<!--[if lte IE 7]>
<link href="inc/template/shop_hydrex/css/patch_my_layout.css" rel="stylesheet" type="text/css" >
<![endif]-->
<?php $Page->put_css(); ?>
<?php $Page->put_js(); ?>
...
<body>
  <div class="page_margins">
    ...
    <div class="page">
      <div id="header">
  		  <div id="header_left" style="padding: 0px;"><a href="/"><img style="float: left;" src="inc/template/shop_hydrex/images/logo_hydrex.png" border="0"></a><?php echo $Page->put_masterhead_html(); ?></div>
        <div id="topnav">
