...
<link href="inc/template/damen_shop/css/my_layout.css" rel="stylesheet" type="text/css" >
<!--[if lte IE 7]>
<link href="inc/template/damen_shop/css/patch_my_layout.css" rel="stylesheet" type="text/css" >
<![endif]-->
<?php $Page->put_css(); ?>
<?php $Page->put_js(); ?>
...
<body style="background: #ededee none; padding: 10px 0;">
  <div class="page_margins">
    ...
    <div class="page">
      <div id="header">
  		  <div id="header_left"><a href="/"><img src="inc/template/damen_shop/images/logo_damen.png" border="0"></a><?php echo $Page->put_masterhead_html(); ?></div>
        <div id="topnav">
