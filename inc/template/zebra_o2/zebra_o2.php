...
<link href="inc/template/zebra_o2/css/nav_shinybuttons.css?ver=<?php echo time(); ?>" rel="stylesheet" type="text/css" >
<link href="inc/template/zebra_o2/css/colorbox.css?ver=<?php echo time(); ?>" rel="stylesheet" type="text/css" >
<link href="inc/template/zebra_o2/css/my_layout.css?ver=<?php echo time(); ?>" rel="stylesheet" type="text/css" >
<?php $Page->put_css(); ?>
<?php $Page->put_js(); ?>
  ...
  <div id="page">
	  <div class="yui3-g" id="header_all">
		  <div class="yui3-u-1 header_part" id="header_top">
			  <div id="header_left"><a href="/"><img src="inc/template/zebra/images/logo_zebra_2.png" border="0"></a>
		  ...
		  <div class="yui3-u-1 header_part" id="header_bottom">
			  <div id="header_bottom_cont">
