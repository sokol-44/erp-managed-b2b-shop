...
<link href="inc/template/ups_seller/css/my_layout.css?ver=<?php echo time(); ?>" rel="stylesheet" type="text/css" >
<link href="inc/template/ups_seller/css/nav_shinybuttons.css?ver=<?php echo time(); ?>" rel="stylesheet" type="text/css" >
<?php $Page->put_css(); ?>
<?php $Page->put_js(); ?>
  ...
  <div id="page">
	  <div class="yui3-g" id="header_all">
		  <div class="yui3-u-1 header_part" id="header_top">
			  <div id="header_left"><a href="/"><img src="inc/template/ups_seller/images/logo_ups_seller.png" border="0" height="64"></a>
