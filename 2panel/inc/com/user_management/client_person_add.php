...
ob_start();
?>
<div class="InfoBox"> toolbox - client_person_add
</div>
<div class="ToolBox">
<?php
echo
$F->draw_link($F->make_link($F->com, $F->make_get('mode')),'', $F->static_image('icon/left_32.png', Lang::_('Back'))) .
$F->static_image('icon/plus_32.png', Lang::_('Add'), 'onclick="form_submit(\'person_edit\')"');
...
<table class="tableBox" style="border: 0">
	...
	<tr>
		...
		<td><?php echo $F->draw_password_field('new_password'); ?></td>
	</tr>
	<tr>
		<td><?php echo Lang::_('RETYPE_PASSWORD') ?></td>
		<td><?php echo $F->draw_password_field('new_password_retype'); ?></td>
	</tr>
	<tr>
		<td><?php echo Lang::_('RIGHTS'); ?></td>
		<td><?php echo $F->show_rights_list('CLIENT', $person_data['rights_ids']); ?></td>
	</tr>
	<tr>
	...
	<tr>
		<td><?php echo Lang::_('CLIENT') ?></td>
		<td><?php echo $F->show_clients_list($F->GET['id_client'], $person_data['id_client']); ?></td>
	</tr>
	<tr>
